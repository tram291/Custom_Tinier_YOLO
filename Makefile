...
LDFLAGS+= -L/usr/local/lib -lopencv_calib3d -lopencv_contrib -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_gpu -lopencv_highgui -lopencv_imgproc -lopencv_legacy -lopencv_ml -lopencv_nonfree -lopencv_objdetect -lopencv_ocl -lopencv_photo -lopencv_video -lrt -lpthread -lm -ldl
COMMON+= -I/usr/local/include -I/usr/local/include/opencv
...
all: obj  results $(SLIB) $(ALIB) $(EXEC) tags $(AOCX)
